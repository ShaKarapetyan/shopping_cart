...
const reducer = (state: CartStateType, action: ReducerAction) : CartStateType => {
    switch (action.type) {
        ...
        default: throw new Error('Unidentifide reducer action type')
    }
}
...
export type UseCardContextType = ReturnType<typeof useCartContext>
...
export const CartContext = createContext<UseCardContextType>(initCartContextState)
